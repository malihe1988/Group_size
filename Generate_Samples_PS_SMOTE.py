...
def generate_samples_PS_SMOTE(no_of_samples, df, df_name):
    ...
    for _ in range(no_of_samples):
        ...
        # Increment parent index to go through dataset sequentially and loop back if it exceeds the dataset size
        parent_idx = (parent_idx + 1) % num_samples
        new_candidate = []
